...
class _Category:
    ...
    def __init__(self, category):
        ...
        for child in category.children:
            tof = type(self).__name__ == 'True_Or_False'
    ...
    def build(self):
        ...
        for kind in kinds:
            ...
            for question in questions:
                ...
                category = type(self).__name__.replace('_', ' ')
...
class True_Or_False(_Category):
    ...
    def build(self):
        ...
        for question in questions:
            assert len(questions[question]) == 1
        self.QnA = []
        for question in questions:
...
class Answer:
    ...
    def __init__(self, answer, tof):
        if tof:
            assert answer.text in ('True', 'False')
